...
public class ComponentActivationMixerBehaviour : PlayableBehaviour
{
    ...
    public override void ProcessFrame(Playable playable, FrameData info, object playerData)
    {
        ...
        for (int i = 0; i < inputCount; i++)
        {
            ...
            ScriptPlayable<ComponentActivationBehaviour> inputPlayable = (ScriptPlayable<ComponentActivationBehaviour>)playable.GetInput(i);
            ComponentActivationBehaviour input = inputPlayable.GetBehaviour ();
